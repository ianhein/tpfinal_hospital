...
class InsurancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insurance" do
    assert_difference('Insurance.count') do
      post insurances_url, params: { insurance: { insurance_name: @insurance.insurance_name, patient_id: @insurance.patient_id } }
    end
  ...
  test "should update insurance" do
    patch insurance_url(@insurance), params: { insurance: { insurance_name: @insurance.insurance_name, patient_id: @insurance.patient_id } }
