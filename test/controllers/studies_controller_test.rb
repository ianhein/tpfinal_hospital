...
class StudiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create study" do
    assert_difference('Study.count') do
      post studies_url, params: { study: { study_cost: @study.study_cost, study_name: @study.study_name } }
    end
  ...
  test "should update study" do
    patch study_url(@study), params: { study: { study_cost: @study.study_cost, study_name: @study.study_name } }
